...
"riscv64\-linux\-gnu-6\.14\.0\-36\-generic" or
	die "Errno architecture (riscv64\-linux\-gnu-6\.14\.0\-36\-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
